...
declare global {
  var __squadpuzzle_redis_kv__: Map<string, { value: string; expiresAt?: number }> | undefined;
  var __squadpuzzle_redis_hashes__: Map<string, Map<string, string>> | undefined;
  var __squadpuzzle_redis_sets__: Map<string, Set<string>> | undefined;
}

const globalKv = (globalThis.__squadpuzzle_redis_kv__ =
  globalThis.__squadpuzzle_redis_kv__ || new Map());
const globalHashes = (globalThis.__squadpuzzle_redis_hashes__ =
  globalThis.__squadpuzzle_redis_hashes__ || new Map());
const globalSets = (globalThis.__squadpuzzle_redis_sets__ =
  globalThis.__squadpuzzle_redis_sets__ || new Map());

class InMemoryRedisStore implements RedisStore {
  private kv = globalKv;
  private hashes = globalHashes;
